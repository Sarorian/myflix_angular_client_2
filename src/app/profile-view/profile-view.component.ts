...
export class ProfileViewComponent implements OnInit{
    ...
    */
    updateField(field: string, value: any): void {
        ...
        for ( const key of ["Username","Password","Email","Birthday"]) {
            if (!postData.hasOwnProperty(key)) {
                postData[key] = this.user[key]
            }
        }

        this.userRegistrationAPI.updateUserInfo(this.user.Username, postData).subscribe(() => {
