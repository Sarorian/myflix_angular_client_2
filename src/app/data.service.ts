...
export class DataService {
    ...
    addFavoriteMovie(id: string):void {
        ...
        //REMOVE FROM SERVER
        this.fetchApiDataService.addFavoriteMovie(this.user.Username, id).subscribe(response=>
            {
                //UPDATE USER
                this.user = response;
    ...
    removeFavoriteMovie(id: string): void {
        ...
        // REMOVE FROM SERVER
        this.fetchApiDataService.deleteFavoriteMovie(this.user.Username, id).subscribe(
        (response) => {
            // UPDATE USER
            this.user = response;
